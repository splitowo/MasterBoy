...
static void sgb_multiplayer_req()
{
	if(sgb_buffer[1]&1) 
	{
		sgb_multiplayer = 1;
...
static void sgb_attribute_line()
{
	byte *fromAddress = &sgb_buffer[1];
...
static void sgb_attribute_divide()
{
	byte i;
...
static void sgb_attribute_character()
{
...
static void sgb_sound_transfer()
{
