...
char menuPlusTerminated;
char menuStickMessageDisplayed = 0;
char menuDisplaySpecialMessage = 0;
char menuMusicLocked;
...
//	oslClearScreen(RGB(0,0,128));
	...
	oslDrawString(0, -1, "MasterBoy v2.02.9 by Brunni");
